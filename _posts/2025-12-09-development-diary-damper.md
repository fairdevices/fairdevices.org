...
<style>
/* Alternative Code-Styling für diese Seite */
.custom-code-block {
...
# Amplitude eines gedämpften Feder-Masse-Schwingers

Das folgende <span class="custom-code-inline">GNU Octave</span> Skript berechnet die Amplitude.
